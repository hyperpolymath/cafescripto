...
= Contributing — cafescripto
:revdate: 2026-MM-DD

== Audience

Developers working *on* `cafescripto`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:hyperpolymath/cafescripto.git
cd cafescripto
...
* Bugs in `cafescripto`: file at `hyperpolymath/cafescripto/issues`.
